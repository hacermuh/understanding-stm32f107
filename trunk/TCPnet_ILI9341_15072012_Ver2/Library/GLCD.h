...
/* Macro definition  */
/********************************************************************************/
#define Set_Cs  GPIOC->BSRR  = 0x00000040; // PC6 = 1 
#define Clr_Cs  GPIOC->BRR   = 0x00000040; // PC6 = 0

#define Set_Rs  GPIOD->BSRR  = 0x00002000; // PD13 = 1
#define Clr_Rs  GPIOD->BRR   = 0x00002000; // PD13 = 0

#define Set_nWr GPIOD->BSRR  = 0x00004000; // PD14 = 1
#define Clr_nWr GPIOD->BRR   = 0x00004000; // PD14 = 0

#define Set_nRd GPIOD->BSRR  = 0x00008000; // PD15 = 1
#define Clr_nRd GPIOD->BRR   = 0x00008000; // PD15 = 0 
/********************************************************************************/
...
extern void GLCD_bitmap         (unsigned int x, unsigned int y, unsigned int w, unsigned int h, const unsigned short *bitmap);
extern void GLCD_clearLn        (unsigned int ln);
extern void GLCD_putPixel       (unsigned int x, unsigned int y);
extern void GLCD_SetCursor      (unsigned short x, unsigned short y);
